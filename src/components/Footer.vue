...
div(v-if="footerShouldBeVisible")
  footer.bg-gray-800.text-white.pt-14.pb-8.mt-16.md_mt-24
    .grid.grid-cols-1.md_grid-cols-12.gap-8.mb-10
      // Column 1: About
      .footer-column.col-start-2.col-span-3.md_col-start-4.md_col-span-3
        h3.text-xl.font-bold.mb-5 {{ $t('footer.about.title') }}
      ...
      .footer-column.col-start-2.col-span-3.md_col-span-1
        h3.text-xl.font-bold.mb-5 {{ $t('footer.links.title') }}
        ul.space-y-2
      ...
      .footer-column.col-start-2.col-span-3.md_col-span-2
        h3.text-xl.font-bold.mb-5 {{ $t('footer.contact.title') }}
