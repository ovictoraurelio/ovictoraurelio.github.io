export default {
  history: [
    ...
    },
    {
      ...
      color: "bg-yellow-olsen",
      date: "October 2017 - atualmente",
      img: "globe",
      office: "Desenvolvedor web full-stack",
    },
    {
      locate: {
        name: "Viitra Inovações",
        link: "http://viitra.com",
      },
      color: "bg-yellow-olsen",
      date: "2 de abril à October de 2017 ",
      img: "globe",
      office: "Desenvolvedor web full-stack",
    },
    {
    ...
    },
    {
      locate: {
        name: "Freelancer",
        link: "http://victoraurelio.com",
      },
      color: "bg-yellow-olsen",
      date: "1 de September de 2015 - nowadays",
      img: "globe",
      office: "Desenvolvedor web e android",
    },
    {
      locate: {
        name: "Septo Mobile",
        link: "http://septomobile.com.br",
      },
      color: "bg-light-grey",
    ...
    {
      locate: {
        name: "Monitoria de informática",
        link: "http://informatica.ifal.edu.br",
      },
      color: "bg-light-grey",
      img: "desktop",
      date: "04/03/2014 - 13/12/2014",
      office: "Monitor de algoritimos e estruturas de dados",
    },
    {
      locate: {
        name: "+Sangue",
        link:
          "https://play.google.com/store/apps/details?id=maissangue.ifal.edu.br",
      },
      color: "bg-light-grey",
      img: "search-plus",
      date: "04/04/2013 - 13/04/2015",
      office: "Colaborador",
      more:
        "Aplicativo android desenvolvido em linguagem nativa (java) com web service ruby on rails, disponível na google play em breve. Equipe: Nywton, Ernande e Victor.",
    },
    {
      locate: {
        name: "Bessas Techonology",
        link: "not_found",
      },
      img: "building",
      color: "bg-light-grey",
      date: "Janeiro de 2013 - December de 2013",
    ...
    },
    {
      locate: {
        name: "IFAL",
        link: "http://ifal.edu.br",
      },
      color: "bg-light-grey",
      img: "graduation-cap",
      date: "06/02/2012 - 21/01/2016",
      office: "Estudante do curso técnico integrado de informática",
      more:
        "Estudante de informática no Instituto Federal de Alagoas, desde 2012. Onde teve contanto com o universo do desenvolvimento de software, desde então, trabalhando em sistemas e aplicativos, para diferentes plataformas.",
    },
  ],
  recents: [
    {
      ...
      subtitle: "Projeto elaborado enquanto trabalhava no grupo Septo Mobile.",
