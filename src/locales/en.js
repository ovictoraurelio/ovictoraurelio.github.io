...
export default {
  ...
  footer: {
    about: {
      title: 'About',
      description: 'I am the COO and co-founder of Beyond Co., as well as CSO at Absens and Legis, where I lead the development of innovative solutions in software, artificial intelligence, and legal intelligence.'
    },
    links: {
      title: 'Quick Links',
      home: 'Home',
